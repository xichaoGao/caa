...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        _WxImg = [[UIImageView alloc]initWithFrame:CGRectMake(12, 10, 80, 60)];
        _WxImg.layer.masksToBounds = YES;
        _WxImg.layer.cornerRadius = 10;
        [self addSubview:_WxImg];
        _nickNameLab = [[UILabel alloc]initWithFrame:CGRectMake(_WxImg.right + 20, _WxImg.top, 150, 15)];
        ...
        _receTimeLab = [[UILabel alloc]initWithFrame:CGRectMake(_receLab.right, _nickNameLab.bottom + 5, 120, 15)];
        ...
        _useTimeLab = [[UILabel alloc]initWithFrame:CGRectMake(_useLab.right, _receTimeLab.bottom + 5, 120, 15)];
