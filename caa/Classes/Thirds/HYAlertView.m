...
-(void)setup
{
    ...
    contentView.backgroundColor = UIColorFromHex(0xe8e8e8);
    ...
    lineView.backgroundColor = UIColorFromHex(0xdadbdd);
    ...
    if(_buttonTitleList.count > 1)
    {
        ...
        lineView1.backgroundColor = UIColorFromHex(0xdadbdd);
    ...
    for (int i = 0; i < _buttonTitleList.count; i++)
    {
        ...
        if ([btn.titleLabel.text isEqualToString:@"确定"]||[btn.titleLabel.text isEqualToString:@"确认"]||[btn.titleLabel.text isEqualToString:@"容我三思"]||[btn.titleLabel.text isEqualToString:@"去登录"]) {
            [btn setTitleColor:UIColorFromHex(0xb51d23) forState:UIControlStateNormal];
        }else{
            [btn setTitleColor:UIColorFromHex(0x646464) forState:UIControlStateNormal];
        }
    ...
    if (self.alertViewStyle == HYAlertViewStyleDefault) {
        ...
        _msgLabel.textColor = UIColorFromHex(0x333333);
